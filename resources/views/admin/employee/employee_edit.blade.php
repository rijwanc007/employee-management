...
@section('content')
    <div class="content-wrapper">
        {!! Form::open(['class' =>'form-sample','route' => ['employee.update',$edit->id],'method' => 'PATCH','enctype' => 'multipart/form-data']) !!}
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <input type="hidden" value="employee" name="account_for"/>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <button type="submit" class="btn btn-gradient-primary btn-lg btn-block"><i class="mdi mdi-account"></i> Update Employee </button>
            </div>
        </div>
        {!! Form::close() !!}
    </div>
