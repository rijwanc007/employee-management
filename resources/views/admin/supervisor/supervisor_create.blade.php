...
@section('content')
    <div class="content-wrapper">
        {!! Form::open(['class' =>'form-sample','route' => 'supervisor.store','method' => 'POST','enctype' => 'multipart/form-data']) !!}
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <input type="hidden" value="supervisor" name="account_for"/>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="role" required>
                                    @foreach($roles as $role)
                                        <option value="{{$role->id}}" @if( $role->role_name == 'supervisor') selected @endif>{{$role->role_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <button type="submit" class="btn btn-gradient-primary btn-lg btn-block"><i class="mdi mdi-account"></i> Create Supervisor </button>
            </div>
        </div>
        {!! Form::close() !!}
    </div>
