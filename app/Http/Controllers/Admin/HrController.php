...
class HrController extends Controller
{
    ...
    {
        $hrs = User::where('account_for','=','hr')->paginate(20);
        return view('admin.hr.index',compact('hrs'));
    }
    public function create()
    {
        $roles =Role::all();
        return view('admin.hr.hr_create',compact('roles'));
    }
    public function store(Request $request)
    {
        ...
        Session::flash('success','HR Created Successfully');
    ...
    public function show($id)
    {
        ...
        return view('admin.hr.hr_show',compact('details','address_details','relative_details','document_details','service_details'));
    }
    public function edit($id)
    {
        ...
        return view('admin.hr.hr_edit',compact('edit','edit_address','edit_relative','edit_document'));
    }
