...
class ClientController extends Controller
{
    ...
    {
        $clients = User::where('account_for','=','client')->paginate(20);
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            ...
            'email' => $request->email,
            'password' => bcrypt('there is something'),
        ...
        $user->services()->create([
            'active_service' => json_encode($request->active_service),
            'service_start' => json_encode($request->service_start),
            'service_end' => json_encode($request->service_end),
            'prospect_service' => $request->prospect_service,
        ]);
    ...
    public function show($id)
    {
        ...
        return view('admin.client.client_show',compact('details','address_details','relative_details','document_details','service_details'));
    }
    public function edit($id)
    {
        $edit = User::find($id);
        if($edit->account_for == 'client'){
            ...
            $edit_service = Services::where('user_id','=',$id)->first();
            return view('admin.client.client_edit',compact('edit','edit_address','edit_relative','edit_document','edit_service'));
        }
    }
    public function update(Request $request, $id)
    {
        ...
        if(!empty($request->image)){
            ...
            $service_update = Services::where('user_id','=',$id)->first();
