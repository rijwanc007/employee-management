...
class SellerController extends Controller
{
    ...
    {
        $sellers = User::where('account_for','=','seller')->paginate(20);
        return view('admin.seller.index',compact('sellers'));
    }
    public function create()
    {
        $roles =Role::all();
        $supervisors = User::where('account_for','=','supervisor')->orderBy('id','DESC')->get();
        return view('admin.seller.seller_create',compact('supervisors','roles'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.seller.seller_show',compact('details','address_details','relative_details','document_details','service_details'));
    }
    public function edit($id)
    {
            ...
            $supervisors = User::where('account_for','=','supervisor')->orderBy('id','DESC')->get();
            return view('admin.seller.seller_edit',compact('edit','edit_address','edit_relative','edit_document','supervisors'));
    }
