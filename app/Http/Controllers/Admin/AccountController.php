...
class AccountController extends Controller
{
    ...
    {
        $accounts = User::where('account_for','=','account')->paginate(20);
        return view('admin.account.index',compact('accounts'));
    }
    public function create()
    {
        $roles =Role::all();
        return view('admin.account.account_create',compact('roles'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.account.account_edit',compact('edit','edit_address','edit_relative','edit_document'));
    }
