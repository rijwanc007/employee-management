...
class SupervisorController extends Controller
{
    ...
    {
        $supervisors = User::where('account_for','=','supervisor')->paginate(20);
        return view('admin.supervisor.index',compact('supervisors'));
    }
    public function create()
    {
        $roles =Role::all();
        return view('admin.supervisor.supervisor_create',compact('roles'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.supervisor.supervisor_show',compact('details','address_details','relative_details','document_details','service_details'));
    }
    public function edit($id)
    {
            ...
            return view('admin.supervisor.supervisor_edit',compact('edit','edit_address','edit_relative','edit_document'));
    }
