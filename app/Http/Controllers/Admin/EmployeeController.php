...
class EmployeeController extends Controller
{
    ...
    {
        $employees = User::where('account_for','=','employee')->paginate(20);
    ...
    {
        if(Auth::user()->account_for == 'hr' || Auth::user()->account_for == 'super_admin' || Auth::user()->id == $id){
            ...
            return view('admin.employee.employee_show',compact('details','address_details','relative_details','document_details','service_details'));
        }
    ...
    public function edit($id)
    {
        ...
        return view('admin.employee.employee_edit',compact('edit','edit_address','edit_relative','edit_document'));
    }
